...
const MyProducts: React.FC = (): JSX.Element => {
  ...
  const getSortedAndFilteredProducts = () => {
    ...
    if (sortOrder === 'latest') {
      ...
      currentProducts.sort(
        (a, b) => b.stock - b.stockSold - (a.stock - a.stockSold)
      );
    }
    ...
    <div id="my-products">
      ...
      <main>
        <header className="filters-header">
          ...
          />
          <strong>
            showing {displayedProducts.length} out of total {products.length}{' '}
            Products
          </strong>
                  ...
                  <tr key={product._id}>
                      ...
                      <label id="active-status">
                        <div className="active-input">
                          {toggleLoading === product._id ? (
                            <img className="loading" src={reload} alt="" />
                          ) : (
                            <input
                              type="checkbox"
                    ...
                    <td className="availability">
                      ...
                      <span>
                        ...
                        {product.stock - product.stockSold}
                      </span>
                    </td>
                    ...
                    <td>
                      <button
                        onClick={() =>
                          toast('Comming soon, under progress', {
                            icon: '🚀',
                          })
                        }
                        title="edit"
                      ...
                      <a
                        target="blank"
                        href={`https://artstoreonline.vercel.app/products/${product._id}`}
                        title="view"
                        className="action"
                      >
                        <FaRegEye />
