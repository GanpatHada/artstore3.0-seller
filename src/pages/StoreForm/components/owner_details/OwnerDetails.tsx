    ...
    <section>
      ...
      <main>
        <div>
          ...
          />
          {state.ownerName.error && (
            <p className="error">{state.ownerName.error}</p>
          )}
        </div>
        <div>
          <label>
            Contact Email <span className="error">*</span>
          </label>
          <input
            type="text"
          ...
          {state.contactEmail.error && (
            <p className="error">{state.contactEmail.error}</p>
          )}
        </div>
        <div>
          <label>
            Contact Phone <span className="error">*</span>
          </label>
          <input
            type="text"
          ...
          {state.contactPhone.error && (
            <p className="error">{state.contactPhone.error}</p>
          )}
        </div>
      </main>
    </section>
