...
const AccountDetails: React.FC = () => {
  ...
  const handleFillAccountNumber = () => {
    dispatch({
      ...
      field: 'accountNumber',
      payload: generateTestAccountNumber(),
    });
  };
    ...
    <section>
      ...
      <main>
        <div>
          ...
          {state.accountHolderName.error && (
            <p className="error">{state.accountHolderName.error}</p>
          )}
        </div>
        <div>
          <label>
          ...
          <div>
            ...
            <button
              type="button"
              onClick={handleFillAccountNumber}
          ...
          {state.accountNumber.error && (
            <p className="error">{state.accountNumber.error}</p>
          )}
        </div>
        <div>
          <label>
          ...
          <div>
            ...
            <button
              type="button"
              onClick={handleFillIfscCode}
              className="fill-random-button"
            >
              Fill Random
            </button>
          </div>
          {state.ifscCode.error && (
            <p className="error">{state.ifscCode.error}</p>
          )}
        </div>
      </main>
    </section>
